      ...
      <div className='mt-10 space-y-12'>
        ...
        <div className='flex justify-around '>
          ...
          <div className='w-[25%] space-y-8'>
            ...
            <h1 className='font-bold text-center w-[45%] mx-auto'>Empowering  Decision-Making</h1>
          ...
          <div className='w-[25%] space-y-8'>
            ...
            <h1 className='font-bold text-center w-[55%] mx-auto'>Centralizing <br /> Open-Source Insights</h1>
          ...
          <div className='w-[25%] space-y-8'>
            ...
            <h1 className='font-bold text-center w-[45%] mx-auto'>Fraud Detection</h1>
      ...
      <div className='mt-20 space-y-12'>
        ...
        <div className='flex justify-around '>
          ...
          <div className='w-[25%] space-y-8'>
            ...
            <h1 className='font-bold text-center w-[45%] mx-auto'>Rising Fraudulent Companies</h1>
          ...
          <div className='w-[25%] space-y-8'>
            ...
            <h1 className='font-bold text-center w-[45%] mx-auto'>Saves Time</h1>
      ...
      <div className='mt-20 space-y-12'>
        ...
        <div className='flex justify-around '>
          ...
          <div className='w-[25%] space-y-8'>
            ...
            <h1 className='font-bold text-center w-[45%] mx-auto'>Reputation Scoring</h1>
          ...
          <div className='w-[25%] space-y-8'>
            ...
            <h1 className='font-bold text-center w-[45%] mx-auto'>Data Aggregation</h1>
